document.addEventListener('DOMContentLoaded', () => {
    ...
    const UI = {
        ...
        updatePlayer(track) {
            ...
            if (title !== playerState.currentTrack.title ||
                ...
                // Removed setting of href since we no longer use links
    ...
    // CHANGES: Remove touch interaction code. Add click toggle for expand/collapse.
    ...
    // Check every 5 mins if tab is active
